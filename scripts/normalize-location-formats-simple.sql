-- ============================================================================
-- Normalize Location Formats (Simple Version)
-- ============================================================================
-- This script standardizes all location formats to S##R#H# (without dashes)
-- to ensure consistency across the application
-- ============================================================================

-- Step 1: Show current location format distribution (simple)
SELECT 
...
-- Step 2: Preview normalization changes for containers (first 10)
SELECT 
...
-- Step 5: Verify normalization results (simple)
SELECT 
