              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  {entries.map(entry => (
                    <div
                      key={entry.id}
                      className="border border-orange-200 bg-orange-50 rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500 mt-0.5 space-x-2">
                            ...
                            {entry.damageType && (
                              <span>• Dommage: <strong className="text-orange-700">{entry.damageType}</strong></span>
                            )}
                          </div>
                          {entry.damageDescription && (
                            <p className="text-xs text-gray-500 mt-0.5 italic">{entry.damageDescription}</p>
                          )}
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  {release.entry!.damageType && (
                    <div>Type de dommage: <strong className="text-orange-700">{release.entry!.damageType}</strong></div>
                  )}
                  {release.entry!.damageDescription && (
                    <div className="italic text-gray-500">{release.entry!.damageDescription}</div>
                  )}
                </div>
              </div>
