        ...
        <div className="absolute z-50 mt-2 bg-white border border-gray-200 rounded-2xl shadow-2xl p-6 w-80 animate-slide-in-up">
          ...
          <div className="grid grid-cols-7 gap-1 mb-3">
            {DAYS.map((day) => (
              <div
                key={day}
                className="w-10 h-8 flex items-center justify-center text-xs font-medium text-gray-500 uppercase tracking-wider"
              >
                {day}
              </div>
            ))}
          ...
          <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-100">
            ...
            <button
              ...
              className="text-sm font-medium text-gray-600 hover:text-gray-800 px-3 py-2 hover:bg-gray-100 rounded-lg transition-colors"
            >
              Close
            </button>
          </div>
