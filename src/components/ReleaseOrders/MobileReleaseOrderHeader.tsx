    ...
    return (
      <div className="bg-white border-b border-gray-200 px-4 py-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-sm">You don't have permission to manage booking references.</p>
        </div>
      </div>
    );
  }
        ...
        <div className="px-4 py-4">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-600">Release orders & container bookings</p>
            </div>
            <button
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 px-6 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105 active:scale-95"
          >
