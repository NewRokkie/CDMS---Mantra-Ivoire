    ...
    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3">
        <button
          ...
          title={t('stack.refresh')}
        >
          <RefreshCw className={`h-4 w-4 flex-shrink-0 ${isRefreshing ? 'animate-spin' : ''}`} />
          <span className="whitespace-nowrap">{isRefreshing ? t('stack.refreshing') : t('stack.refresh')}</span>
        </button>
        <button
        ...
        >
          ...
          <span className="whitespace-nowrap">{t('stack.create')}</span>
        </button>
        {hasChanges && (
          <>
            <button
            ...
            >
              ...
              <span className="whitespace-nowrap">{t('stack.resetChanges')}</span>
            </button>
            <button
              onClick={onSave}
            ...
            >
              ...
              <span className="whitespace-nowrap">{t('stack.saveChanges')}</span>
            </button>
          </>
        )}
      </div>
