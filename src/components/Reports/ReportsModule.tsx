    ...
    <div className="space-y-6">
      ...
      {activeTab === 'billing' && (
        <div className="space-y-6">
          ...
          {/* Client Free Days Configuration */}
          <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900">Client Free Days Configuration</h3>
              <p className="text-sm text-gray-600">Free days allowed per client and daily storage rates</p>
            </div>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {mockClientFreeDays.map((client) => {
                    const activeContainers = filteredData.filter(
                      item => item.clientCode === client.clientCode && item.status === 'active'
                    ).length;
                    ...
                    return (
                      <tr key={client.clientCode} className="hover:bg-gray-50 transition-colors">
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="ml-3">
                              <div className="text-sm font-medium text-gray-900">
                                {canViewAllData() ? client.clientName : 'Your Company'}
                              </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                          {formatCurrency(client.dailyRate)}/day
                        </td>
