            ...
            <div className="overflow-x-auto max-h-96">
              ...
              {filteredData.containers.length === 0 && (
                <div className="text-center py-8">
                  <Package className="h-10 w-10 mx-auto text-slate-300 dark:text-gray-600" />
                  <h3 className="text-lg font-medium mt-3 dark:text-white">No containers found</h3>
                  <p className="text-sm text-slate-500 dark:text-gray-400 mt-1">No containers match the selected filter criteria.</p>
                </div>
              )}
            </div>
          </Card>
